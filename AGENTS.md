# AGENTS.md — Diff Commit Message VS Code Extension

This file provides guidance for agentic coding agents working in this repository.

## Project Overview

**Diff Commit Message** is a VS Code extension that generates AI-powered conventional commit messages from staged git diffs. It features a robust, refactored architecture with multi-server failover, accurate token monitoring, and multi-provider support (OpenAI, Azure, Gemini, DeepSeek).
